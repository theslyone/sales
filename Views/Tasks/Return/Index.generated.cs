...
WriteLiteral(">Sales Returns</div>\r\n    <div");
...
"rocessQuery() {\r\n        function getModel() {\r\n            const model = window" +
".serializeForm($(\"#Annotation\"));\r\n            model.Book = \"Sales Return\";\r\n   " +
"         return model;\r\n        };\r\n\r\n        function displayGrid(target) {\r\n  " +
"          function request(model) {\r\n                const url = \"/dashboard/fin" +
"ance/tasks/journal/view\";\r\n                const data = JSON.stringify(model);\r\n" +
"                return window.getAjaxRequest(url, \"POST\", data);\r\n            };" +
"\r\n\r\n            const model = getModel();\r\n\r\n            const ajax = request(mo" +
"del);\r\n\r\n            ajax.success(function (response) {\r\n                display" +
"Table(target, response);\r\n                target.removeClass(\"loading\");\r\n      " +
"      });\r\n\r\n            ajax.fail(function (xhr) {\r\n                alert(JSON." +
"stringify(xhr));\r\n            });\r\n        };\r\n\r\n        const view = $(\"#SalesV" +
"iew\").addClass(\"loading\");\r\n\r\n        displayGrid(view);\r\n    };\r\n\r\n    $(\"#Show" +
"Button\").unbind(\"click\").bind(\"click\", function () {\r\n        processQuery();\r\n " +
"   });\r\n\r\n    loadDatepicker();\r\n\r\n    setTimeout(function () {\r\n        process" +
"Query();\r\n    }, 1000);\r\n\r\n    \r\n    function showInvoice(tranId) {\r\n        $(\"" +
".advice.modal iframe\").attr(\"src\", \"/dashboard/reports/source/Areas/MixERP.Sales" +
"/Reports/Invoice.xml?transaction_master_id=\" + tranId);\r\n\r\n        setTimeout(fu" +
"nction () {\r\n            $(\".advice.modal\")\r\n                .modal(\'setting\', \'" +
"transition\', \'horizontal flip\')\r\n                .modal(\"show\");\r\n\r\n        }, 3" +
"00);\r\n    };\r\n    function showJournalAdvice(tranId) {\r\n        $(\".modal iframe" +
"\").attr(\"src\", \"/dashboard/reports/source/Areas/MixERP.Finance/Reports/JournalEn" +
"try.xml?transaction_master_id=\" + tranId);\r\n\r\n        setTimeout(function () {\r\n" +
"            $(\".advice.modal\")\r\n                .modal(\'setting\', \'transition\', " +
"\'horizontal flip\')\r\n                .modal(\"show\");\r\n\r\n        }, 300);\r\n    };\r" +
"\n\r\n    $(\"#ReturnButton\").click(function() {\r\n        function getSelectedItem()" +
" {\r\n            const selected = $(\"#SalesView\").find(\"input:checked\").first();\r" +
"\n\r\n            if (selected.length) {\r\n                const row = selected.pare" +
"nt().parent().parent();\r\n                const id = row.find(\"td:nth-child(3)\")." +
"html();\r\n                return parseInt(id);\r\n            };\r\n\r\n            ret" +
"urn 0;\r\n        };\r\n\r\n        const selected = getSelectedItem();\r\n        if (s" +
"elected) {\r\n            const url = \"/dashboard/sales/tasks/return/new?Transacti" +
"onMasterId=\" + selected;\r\n            document.location = url;\r\n            retu" +
"rn;\r\n        };\r\n\r\n        window.displayMessage(\"Please select an item from the" +
" grid.\");\r\n    });\r\n</script>");
